...
#   Usage:
#        chmod +x shadowsocks-libev-centos.sh
#        ./shadowsocks-libev-centos.sh 2>&1 | tee shadowsocks-libev-centos.log
#    Uninstall:
#        ./shadowsocks-libev-centos.sh uninstall
#    Upgrade:
#        ./shadowsocks-libev-centos.sh uninstall 
#        ./shadowsocks-libev-centos.sh 2>&1 | tee shadowsocks-libev-centos.log
#===============================================================================================
...
echo "# Usage:                                                                    #"
echo "#     chmod +x shadowsocks-libev-centos.sh                                  #"
echo "#     ./shadowsocks-libev-centos.sh 2>&1 | tee shadowsocks-libev-centos.log #"
echo "# Uninstall:                                                                #"
echo "#     ./shadowsocks-libev-centos.sh uninstall                               #"
echo "# Upgrade:                                                                  #"
echo "#     ./shadowsocks-libev-centos.sh uninstall                               #"
echo "#     ./shadowsocks-libev-centos.sh 2>&1 | tee shadowsocks-libev-centos.log #"
echo "#############################################################################"
