...
echo "# Usage:                                                                    #"
echo "#     chmod +x shadowsocks-libev-debian.sh                                  #"
echo "#     ./shadowsocks-libev-debian.sh 2>&1 | tee shadowsocks-libev-debian.log #"
echo "# Uninstall:                                                                #"
echo "#     ./shadowsocks-libev-debian.sh uninstall                               #"
echo "# Upgrade:                                                                  #"
echo "#     ./shadowsocks-libev-debian.sh uninstall                               #"
echo "#     ./shadowsocks-libev-debian.sh 2>&1 | tee shadowsocks-libev-debian.log #"
echo "#############################################################################"
